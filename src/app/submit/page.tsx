      ...
      <section className="relative mx-auto max-w-6xl">
        <div className="overflow-hidden rounded-3xl border border-blue-500/30 bg-gradient-to-br from-zinc-900 via-zinc-950 to-purple-950/30 p-6 text-center shadow-2xl shadow-blue-950/40 ring-1 ring-purple-500/20 sm:p-10">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-base leading-7 text-zinc-300 sm:text-lg">
            ...
            add an event, report an issue, or find answers to common questions.
          </p>
          ...
          <div className="mx-auto mt-7 grid max-w-3xl gap-3 sm:grid-cols-3">
            ...
            <div className="rounded-2xl border border-pink-500/20 bg-black/35 px-4 py-3">
              <p className="text-lg font-black text-white">FAQ</p>
              <p className="mt-1 text-xs text-zinc-400">Quick answers</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 grid gap-5 lg:grid-cols-3">
          ...
          <Link
            href="/submit/faq"
            className="group overflow-hidden rounded-3xl border border-pink-500/30 bg-gradient-to-br from-zinc-900 via-zinc-950 to-pink-950/25 p-6 shadow-2xl shadow-pink-950/25 ring-1 ring-pink-500/10 transition hover:-translate-y-1 hover:border-pink-400/70 hover:shadow-pink-900/40 sm:p-7"
          >
            <div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-pink-400/30 bg-pink-500/15 text-3xl shadow-lg shadow-pink-950/30">
              ❓
            </div>
            ...
            <p className="mt-3 leading-7 text-zinc-300">
              Find quick answers about Scene Finder, listings, events, venues,
              private parties and reporting incorrect information.
            </p>

            <div className="mt-6 inline-flex items-center rounded-xl border border-pink-500/40 bg-pink-500/10 px-4 py-2 text-sm font-bold text-pink-200 transition group-hover:border-pink-400 group-hover:bg-pink-500/20">
              Read FAQ →
            </div>
          </Link>
        </div>
